...
class HrAnnouncements(models.Model):
    ...
    def _announcement_count(self):
        ...
        for obj in self:
            ...
            announcement_ids = announcement_ids_general.ids + announcement_ids_emp.ids + \
                announcement_ids_dep.ids + announcement_ids_job.ids
    ...
    def announcement_view(self):
        ...
        for obj in self:
            ...
            ann_obj = announcement_ids_general.ids + announcement_ids_emp.ids + \
